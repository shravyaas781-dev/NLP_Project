  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen flex flex-col" style={{ backgroundImage: 'url(/Blue.jpg)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
        ...
        <div className="border-b border-gray-200 px-6 py-4" style={{ backgroundColor: '#CCE6F4' }}>
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
          <div className="w-full max-w-3xl">
            <p className="text-xl font-bold text-center mb-8" style={{ color: '#BA324F' }}>
              Paste a paper's title and abstract to classify it into an ArXiv category
            </p>
            <div className="rounded-2xl shadow-md p-8" style={{ backgroundColor: '#CCE6F4' }}>
              {result
            ...
            <div className="mt-6 text-center">
              <p className="text-sm font-bold" style={{ color: '#BA324F' }}>
        ...
        {/* Footer */}
        <div className="py-4">
          <p className="text-sm text-center font-bold" style={{ color: '#BA324F' }}>
